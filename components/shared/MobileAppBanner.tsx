    ...
    <section className="relative w-full py-12 bg-gradient-to-r from-[#4c5f4e] to-[#3a4a3b] overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div 
            className="text-center md:text-left max-w-2xl animate-fade-in-left"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              {/* Apple App Store button removed as per instructions to simplify animations */}
          ...
          <div 
            ...
            // Animation removed as per instructions to simplify animations
            // Added simple CSS animation if needed, e.g., animate-float
          >
        ...
        {/* Early Access Form */}
        <div className="mt-12 bg-white/10 backdrop-blur-md rounded-xl p-6 max-w-3xl mx-auto animate-fade-in-up">
